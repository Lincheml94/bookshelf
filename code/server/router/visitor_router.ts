...
import VisitorController from "../controleur/visitor_controller";
...
class VisitorRouter {
	...
	public getRoutes = () => {
		...
		this.router.get("/", new VisitorController().index);

		// variable de route ; précédée par un :; suivie du nom de la variable
		this.router.get("/:id", new VisitorController().selectOne);
